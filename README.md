...
- Once a weather command is recognized, an appropriate action (e.g current weather conditions in san francisco) is taken and TJ verbalizes this action as well using  [Watson Text to Speech](https://www.ibm.com/watson/developercloud/text-to-speech.html) to generate an audio file.
